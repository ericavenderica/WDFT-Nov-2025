...
function App() {
  ...
  function handleDeletePet(petId) {
    const filteredPets = petState.filter((aPet) => {
      if (aPet.id !== petId) {
        return true;
      }
    });
    ...
    <>
      ...
      <main>
        ...
        <Routes>
          ...
          <Route
            path="/create-a-pet"
            element={<CreatePet pets={petState} setPetState={setPetState} />}
          />
          <Route
            path="/pets-list"
            element={
              <PetsListPage pets={petState} handleDeletePet={handleDeletePet} />
            }
          />
          <Route
          ...
          <Route
            path="/edit-pet/:petId"
            element={
              <EditPetPage petState={petState} setPetState={setPetState} />
            }
          />
